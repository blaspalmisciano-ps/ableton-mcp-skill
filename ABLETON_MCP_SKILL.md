...
| **Research real drummers before programming** | When user asks for a style (e.g. "Phil Collins drums", "like Come Together", "Anderson Paak groove"), ALWAYS search the internet first for that drummer/song's specific patterns: BPM, kick/snare placement, hi-hat style, ghost notes, fills, swing amount. Build the pattern from real analysis, not guessing. Use sites like drummagazine.com, drum-hub.com, songbpm.com, and chord/tab sites for breakdowns. |
